...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private final LinearSystem<N1, N1, N1> m_flywheelPlant =
      LinearSystemId.createFlywheelSystem(
          DCMotor.getNEO(2), kFlywheelMomentofIntertia, kFlywheelGearing);
  ...
  private final KalmanFilter<N1, N1, N1> m_flywheelObserver =
      new KalmanFilter<>(
          Nat.N1(),
          Nat.N1(),
          m_flywheelPlant,
          VecBuilder.fill(kFlywheelModelAccuracy),
          VecBuilder.fill(kFlywheelEncoderAccuracy),
          0.020);
  ...
  private final LinearQuadraticRegulator<N1, N1, N1> m_flywheelController =
      new LinearQuadraticRegulator<>(
          m_flywheelPlant,
          VecBuilder.fill(kFlywheelQelmsVTolerance),
          VecBuilder.fill(kFlywheelRelmsControlEffort),
          0.02);
  ...
  private final LinearSystemLoop<N1, N1, N1> m_loop =
      new LinearSystemLoop<>(
          m_flywheelPlant, m_flywheelController, m_flywheelObserver, 12.0, 0.020);

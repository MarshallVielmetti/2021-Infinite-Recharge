...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final CANEncoder m_leftEncoder =
      m_motorL1.getEncoder(EncoderType.kQuadrature, kEncoderResolution);
  private final CANEncoder m_rightEncoder =
      m_motorR1.getEncoder(EncoderType.kQuadrature, kEncoderResolution);

  private final SpeedControllerGroup m_leftMotorGroup =
      new SpeedControllerGroup(m_motorL1, m_motorL2, m_motorL3);
  private final SpeedControllerGroup m_rightMotorGroup =
      new SpeedControllerGroup(m_motorR1, m_motorR2, m_motorR3);

  private final Gyro m_gyro = null; // TODO Make sure actually on the robot

  private final PIDController m_leftPIDController =
      new PIDController(0.6, 0.00001, 0.003); // TODO Assign values
  private final PIDController m_rightPIDController =
      new PIDController(0.6, 0.00001, 0.003); // TODO Assign values

  private final DifferentialDriveKinematics m_kinematics =
      new DifferentialDriveKinematics(kTrackWidth); // TODO
  // screwing
  // up drive
  ...
  public void drive(double xSpeed, double rot) {
    DifferentialDriveWheelSpeeds wheelSpeeds =
        m_kinematics.toWheelSpeeds(new ChassisSpeeds(xSpeed, 0.0, rot));

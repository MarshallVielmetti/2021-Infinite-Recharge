...
/**
 * 1st - speeds up the fly wheel & targets turret w/Vision 2nd - Maintains speeds, begins doing
 * smart shoot
 */
public class SmartTurretCommand extends ParallelCommandGroup {
   ...
   *     <p>This command does the entire process of spinning the flywheel, and ligning turret and
   *     hood. Then it should maintain those positions while also shooting balls / spinning the
   *     spindexer and hold eventually graduate this to doing the smart spin or whatever
   *     <p>Parallel setup new parallel, one cmd grp maintains and another cmd group runs hood
   *     <p>Should run the second parallel command group until the whileHeld condition is met.
   */
  public SmartTurretCommand(
